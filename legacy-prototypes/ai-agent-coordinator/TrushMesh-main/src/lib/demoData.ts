...
export const DEMO_JOBS: Job[] = [
  ...
  },
  {
    ...
    description: "ETH/USDC arbitrage between Orca and Raydium pools",
    template: "PORTFOLIO_REBALANCER",
    budgetSol: "0.12",
    status: "COMPLETE",
    agentCount: 2,
  ...
  },
  {
    ...
    description: "Rebalance mETH/ETH ratio for liquid staking optimisation",
    template: "PORTFOLIO_REBALANCER",
    budgetSol: "0.03",
    status: "REVOKED",
    agentCount: 2,
  ...
  },
  {
    ...
    ownerId: WALLETS.alice,
    ownerSolName: "alice.sol",
    description: "Collect DeFi TVL data across top Arbitrum Sepolia protocols",
    template: "DATA_FETCHER",
    budgetSol: "0.01",
    status: "PENDING",
    agentCount: 0,
...
export const DEMO_MESSAGES_JOB1: AgentMessage[] = [
  makeMsg("msg001", AG.alicePlanner, "planner.alice.sol", AG.aliceExecutor, "executor.alice.sol",
    "Fetch current ETH/USDC spot price from Jupiter aggregator",
  ...
  makeMsg("msg002", AG.aliceExecutor, "executor.alice.sol", AG.alicePlanner, "planner.alice.sol",
    "Price fetched: 1 ETH = $142.87 USDC (Jupiter best route)",
  ...
  makeMsg("msg004", AG.aliceExecutor, "executor.alice.sol", AG.aliceConfirmer, "confirmer.alice.sol",
    "Execute swap: sell 59.81 USDC → ETH via Orca concentrated pool",
  ...
  makeMsg("msg005", AG.aliceConfirmer, "confirmer.alice.sol", AG.aliceExecutor, "executor.alice.sol",
    "Swap confirmed on-chain — received 0.418 ETH, txHash: 5Zx9...",
  ...
  makeMsg("msg006", AG.aliceExecutor, "executor.alice.sol", AG.alicePlanner, "planner.alice.sol",
    "Rebalance complete. Portfolio now 60.2% ETH / 39.8% USDC",
  ...
  makeMsg("msg008", AG.aliceExecutor, "executor.alice.sol", AG.aliceConfirmer, "confirmer.alice.sol",
    "Balance confirmed: 2.31 ETH + 130.42 USDC — ratio 60.1/39.9, within tolerance",
