...
const RECIBO_ADDRESS = process.env.NEXT_PUBLIC_CONTRACT_ADDRESS as `0x${string}` || '0xe7f1725e7734ce288f8367e1bb143e90bb3f0512';
...
export default function InvoicePage() {
  ...
  const handleGenerate = useCallback(() => {
    ...
    const dueTimestamp = dueDate ? BigInt(new Date(dueDate).getTime() / 1000) : BigInt(0);
